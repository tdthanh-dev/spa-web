...
const ROUTE_CONFIG = {
  ADMIN: {
    ...
    customerProfile: { path: '/admin/customers/:customerId', component: CustomerProfile, roles: ['ADMIN'] },
  ...
  RECEPTIONIST: {
    ...
    customerProfile: { path: '/receptionist/customers/:customerId', component: CustomerProfile, roles: ['RECEPTIONIST'] },
    checkin: {
  ...
  TECHNICIAN: {
    ...
    customerProfile: { path: '/technician/customers/:customerId', component: CustomerProfile, roles: ['TECHNICIAN'] },
