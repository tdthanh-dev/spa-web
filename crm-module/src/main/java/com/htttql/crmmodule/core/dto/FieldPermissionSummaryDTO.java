...
/**
 * DTO for summarizing field-level permissions for a staff member
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class FieldPermissionSummaryDTO {
    ...
    private Map<String, Boolean> fieldPermissions; // field -> canRead/canWrite

    // Permission level assessment
    private String permissionLevel; // NONE, BASIC, EXTENDED, FULL, ADMIN
